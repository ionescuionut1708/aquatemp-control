...
float setpoint = 25.0; // Valoare implicită [grade Celsius]
float u_de_k = 0;
...
void loop() {
  ...
  if(u_de_k > 160) u_de_k = 160; //limitare pentru a nu deterioara elementul de incalzirea apei
  ...
  // Modificăm formatul datelor trimise către ESP8266
  ...
  Serial1.print(",");
  Serial1.println(u_de_k);  // Adăugăm valoarea PWM (u_de_k) la datele trimise
